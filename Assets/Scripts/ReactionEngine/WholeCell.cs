...
public class WholeCell : MonoBehaviour {
    ...
    void Update() {
        ...
        Logger.Log(string.Format("dt={0:e2}s scaled to {1:e2}min", Time.deltaTime, elapsedMinutes), Logger.Level.ONSCREEN);
    ...
    void updateλ() {
        ...
        Logger.Log(string.Format("lambda={0:e2}", λ), Logger.Level.ONSCREEN);
    }
