...
{
	private Medium _srcMedium;
	//!< The source Medium (Where substrate will be consumed)
	private Medium _dstMedium;
	//!< The destination Medium (Where product will be released)

	public Medium getSrcMedium ()
	{
		return _srcMedium;
	}

	public Medium getDstMedium ()
	{
		return _dstMedium;
	}

	public void setSrcMedium (Medium med)
	{
		_srcMedium = med;
	}

	public void setDstMedium (Medium med)
	{
		_dstMedium = med;
	}
   ...
   */
	public override void react (Dictionary<string, Molecule> molecules)
	{
		...
		var molSrcMed = _srcMedium.getMolecules ();
		var molDstMed = _dstMedium.getMolecules ();
