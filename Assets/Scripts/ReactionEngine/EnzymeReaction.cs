 ...
 */
public class EnzymeReaction : Reaction
{
	protected string _substrate;
	//!< The substrate of the reaction
	protected string _enzyme;
	//!< The enzyme of the reaction
	protected float _Kcat;
	//!< Reaction constant of enzymatic reaction
	protected string _effector;
	//!< The effector of the reaction
	protected float _alpha;
	//!< Alpha descriptor of the effector
	protected float _beta;
	//!< Beta descriptor of the effector
	protected float _Km;
	//!< Affinity coefficient between substrate and enzyme
	protected float _Ki;
	//!< Affinity coefficient between effector and enzyme
	...
	public void setKcat (float value)
	{
		_Kcat = value;
	}

	public float getKcat ()
	{
		return _Kcat;
	}
	...
	public void setEffector (string str)
	{
		_effector = str;
	}
   ...
   */
	public static Reaction       buildEnzymeReactionFromProps (EnzymeReactionProperties props)
	{
		if (props == null)
			return null;
   ...
   */
	public float execEnzymeReaction (Dictionary<string, Molecule> molecules)
	{
