...
public class PromoterParser
{
    ...
    */
     ...
     */
    public static void PPRecTree(TreeNode<PromoterNodeData> node, ref string str)
    {
        if (node != null)
        {
    ...
    */
    public static string PPTree(TreeNode<PromoterNodeData> tree)
    {
        string output;
        if (tree == null)
        {
            Debug.LogWarning("PromoterParser PPTree failed");
        }
        output = "Digraph G {";
