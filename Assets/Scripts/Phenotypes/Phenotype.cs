...
public abstract class Phenotype : MonoBehaviour
{
	...
	//!< The ReactionEngine (ReactionEngine)
	private static int _characterMediumID = 1;
	//!< The medium id of the character
	private int _mediumId = _characterMediumID;
	//!< The medium id

	protected static Dictionary<string, Molecule> _molecules;
